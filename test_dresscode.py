...
def main():
    ...
    if opt.unpaired:
        dataset = Dataset(opt.dataroot, phase='test', order='unpaired',category = 'all')
    else:
        dataset = Dataset(opt.dataroot, phase='test', order='paired',category = 'all')
        ...
        with precision_scope("cuda"):
            with model.ema_scope():
                for data in iterator:
                    ...
                    # Use EMASC
                    # posterior_im, _ = model.vae.encode(data["GT"].cuda())
